export default function CoinIcon({height, width, className = ''}) {
    return (
        <svg fill="#ffa579" width={width} height={height} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#ffa579">
